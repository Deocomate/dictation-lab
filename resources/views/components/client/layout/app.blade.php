...
<head>
  ...
  <title>{{ $title ?? 'Dictation Lab — Chép chính tả song ngữ đa chủ đề' }}</title>
  <meta name="description"
    content="Học tiếng Anh qua chép chính tả song ngữ Anh-Việt: báo chí, truyện ngắn, TED Talks. Tăng phản xạ qua muscle memory." />
